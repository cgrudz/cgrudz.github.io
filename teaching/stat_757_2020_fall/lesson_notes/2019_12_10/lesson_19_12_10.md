...
[1,]  -0.5473218 0.008593021 0.03781006 -0.009668361 0.008096676
         income
[1,] 0.02122764

$se.mi
     (Intercept)        race        fire       theft        age     income
[1,]   0.6312709 0.002778617 0.009915244 0.005814835 0.00332381 0.04360902
```
...
```
 (Intercept)         race         fire        theft          age 
-0.608978989  0.009132510  0.038816556 -0.010297613  0.008270715 
      income 
 0.024500055 
```
...
```
     (Intercept)     race     fire     theft      age    income
[1,]  -0.8670158 3.092553 3.813326 -1.662706 2.435962 0.4867718
```
...
* In addition, we have introduced a number of special topics in regression analysis, e.g., Generalized least squares, missing values, PCA, advanced model selection techniques, etc...
