...
$$\parallel \tilde{\mathbf{f}}(\mathbf{x}_1) \parallel \leq tol,$$ 
...
* Step 4: If the number of iterations has exceeded `max_iter` or if 
 $$\parallel \mathbf{x}_1 - \mathbf{x}_0 \parallel \leq tol,$$ 
 break the function. 
...
$$\parallel \mathbf{x}_1 - \mathbf{x}_0 \parallel = \parallel \boldsymbol{\delta} \parallel \leq tol.$$ 
