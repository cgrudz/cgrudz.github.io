...
We suppose that this is written in the file "feline-data_v2.csv" which we will read with "read.csv()". Download the feline-data-v2.csv from this <a href="https://cgrudz.github.io/teaching/stat_445_645_2020_fall/activities/feline-data_v2.csv">link</a> and then run the following code
